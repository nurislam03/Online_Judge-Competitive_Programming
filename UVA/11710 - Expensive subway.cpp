...
int main()
{
    ...
    int nStations, nConnection;
    while(scanf("%d %d",&nStations,&nConnection))
    {
        if(nStations == 0 && nConnection == 0) break;
        ...
        mstEdgeCnt = 0;
        int res = MST();
        if(mstEdgeCnt == nStations-1) printf("%d\n",res);
